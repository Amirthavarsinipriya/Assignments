...
##IMDB Reviews###
aurl<-"http://www.imdb.com/title/tt0451279/reviews?start="
IMDB_reviews <- NULL
for (i in 1:10){
...
length(IMDB_reviews)
setwd("C://Users//Gany//Desktop//17.Text Mining")
write.table(IMDB_reviews,"Wonderwomen.txt",row.names = F)
Wonderwomen<- read.delim('Wonderwomen.txt')
str(Wonderwomen)
View(Wonderwomen)

# Build Corpus and DTM/TDM
library(tm)
corpus <- Wonderwomen[-1,]
head(corpus)
class(corpus)
...
# Read File 
IMDB_reviews <- read.delim('Wonderwomen.TXT')
